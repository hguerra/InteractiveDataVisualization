...
public class Data implements Comparable<Data> {
	...
	public boolean equals(Object o) {
		...
		if (!title.equals(data.title))
			return false;
		if (reference != null ? !reference.equals(data.reference) : data.reference != null)
			return false;
		if (format != data.format)
			return false;
		if (!filepath.equals(data.filepath))
			return false;
		if (date != null ? !date.equals(data.date) : data.date != null)
			return false;
		if (!colors.equals(data.colors))
			return false;
		if (description != null ? !description.equals(data.description) : data.description != null)
			return false;
		if (column != null ? !column.equals(data.column) : data.column != null)
			return false;
