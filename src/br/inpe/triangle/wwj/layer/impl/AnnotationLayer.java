...
public class AnnotationLayer implements LayerController {
	...
	public AnnotationLayer buildAnnotation() {
		ScreenAnnotation sa = new ScreenAnnotation(data.getTitle(), new Point(470, 700));
		...
		if (data.getReference() != null && !data.getReference().isEmpty()) {
			ScreenAnnotation sa3 = new ScreenAnnotation(data.getReference(), new Point(470, 15));
	...
	public gov.nasa.worldwind.layers.AnnotationLayer get() {
