...
public class HandPosition {
	 ...
	 * 
	 * if (rightHandCoords.size() > MAX_POINTS) { rightHandCoords.remove(0); } }
	 * 
	 * public synchronized void addLeftHandPoint(PVector realtPoints) {
	 * leftHandCoords.add(realtPoints); if (leftHandCoords.size() > MAX_POINTS)
	 * { leftHandCoords.remove(0); } }
	 * 
	 * public PVector getLeftHandCoords() { if (leftHandCoords.size() >=
	 * MAX_POINTS) { return leftHandCoords.get(MAX_POINTS - 1); } else { return
	 * leftHandCoords.get(0); } }
	 * 
	 * public PVector getLeftHandPreviousCoords() { return
	 * leftHandCoords.get(0); }
	 * 
	 * public PVector getRightHandPreviousCoords() { return
	 * rightHandCoords.get(0); }
	 * 
	 * public PVector getRightHandCoords() { if (rightHandCoords.size() >=
	 * MAX_POINTS) { return rightHandCoords.get(MAX_POINTS - 1); } else { return
	 * rightHandCoords.get(0); } }
	 */
	...
	public String getLast() {
		String str = (String) collectionRightHandCoords.toArray()[collectionRightHandCoords
				.size() - 1];
