...
public class HandPosition {
	...
	public double getRightDeltaX() {
		return (double) getRightHandCoords().x - getRightHandPreviousCoords().x;
	}

	public double getRightDeltaY() {
		return (double)getRightHandCoords().y - getRightHandPreviousCoords().y;
	}

	public double getLeftDeltaX() {
		return (double) getLeftHandCoords().x - getLeftHandPreviousCoords().x;
	}

	public double getLeftDeltaY() {
		return (double) getLeftHandCoords().y - getLeftHandPreviousCoords().y;
	}
