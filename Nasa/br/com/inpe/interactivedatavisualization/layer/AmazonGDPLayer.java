...
//         	 }
        	...
        	String[] splitStr = muniData.get(i).getCentroid().split(",");	
        	 ...
        	 if(muniData.get(i).getName().equals("Santarém") || muniData.get(i).getName().contains("Belém") || muniData.get(i).getName().contains("Altamira") || i == maxPos){
        	   GlobeAnnotation ga2 = new GlobeAnnotation(muniData.get(i).getName()+"\nPIB/Pessoa: "+f2.format(gdp*1000/pop*0.400125419)+"€",Position.fromDegrees(Double.parseDouble(splitStr[1]), Double.parseDouble(splitStr[0]),8000* gdp/pop), Font.decode("Arial-BOLD-12"));
...
//         System.out.println("min: "+minDefor +" max: "+maxDefor);
	...
	public AnnotationLayer addAnnotations(){
        ...
        //PT-BR
        ScreenAnnotation sa = new ScreenAnnotation("PIB e desmatamento anual no Pará, Brasil", new Point(470, 700));
 ...
 //       defaultAttributes2.setBackgroundColor(new Color(0f, 0f, 0f, .5f));
        ...
        //PT-BR
        ScreenAnnotation legendHeader = new ScreenAnnotation("Desmatamento Anual \n \n -Alto desmatamento \n\n\n \n \n \n\n   -Baixo desmatamento", new Point(920, 270));
...
//        annotationLayer.addAnnotation(ifgiLogo);
        ...
        //PT-BR
        ScreenAnnotation heightLegend = new ScreenAnnotation("Altura representa PIB por pessoa", new Point(920,65));
...
//        generalAnnotationLayer.addAnnotation(gdpAnnotation);
        ...
        if(year == "2002"){
        	...
        	statAnnotation.setText("Pará \n População: " +f2.format((int)population) + "\n Desmatamento Anual: "+f.format(averageDefor*100) +"%\nÁrea deflorestada anualmente: "+f.format(averageDefor*totalArea) +"km²\n PIB: "+f.format(averageGDP*0.400125419)+"€");
        }
        if(year == "2003"){
        ...
        if(year == "2004"){
        	factAnnotation.setText("O desmatamento anual de "+f.format(averageDefor*totalArea)+ "km² representa " +f.format(averageDefor*totalArea/2569.69) +" vezes a área de Saarland.");
        	statAnnotation.setText("Pará \n População: " +f2.format((int)population) + "\n Desmatamento Anual: "+f.format(averageDefor*100) +"%\nÁrea deflorestada anualmente: "+f.format(averageDefor*totalArea) +"km²\n PIB: "+f.format(averageGDP*0.400125419)+"€");
        ...
        if(year == "2008"){
        	factAnnotation.setText("O Brasil utiliza 16000 km² ("+(f.format(16000/2569.69))+"x Saarland) para suprir a demanda de soja da Alemanha.");
        	statAnnotation.setText("Pará \n População: " +f2.format((int)population) + "\n Desmatamento Anual: "+f.format(averageDefor*100) +"%\nÁrea deflorestada anualmente: "+f.format(averageDefor*totalArea) +"km²\n PIB: "+f.format(averageGDP*0.400125419)+"€");

        }
        
//        ScreenAnnotation backgroundAnnotation = new ScreenAnnotation("Fakten über Para", new Point(165, 80));
...
//        
////        ScreenAnnotation factAnnotation = new ScreenAnnotation("Fakten über Para:", new Point(30, 425));
////        factAnnotation.getAttributes().setDefaults(defaultAttributes2);
////        factAnnotation.getAttributes().setCornerRadius(0);
